...
const calctext = `03/22 08:54:24 INFO   :......rsvp_flow_stateMachine: state RESVED, event T1OUT
...
fs.writeFile("log.txt", calctext, (err, calctext) => {
    if (err) console.log(err);
    console.log("Data Berhasil Ditulis Kedalam File Log");
});
